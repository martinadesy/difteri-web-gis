<nav class="navbar navbar-top navbar-expand navbar-dark bg-gradient-blue border-bottom">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="#!" class="list-group-item list-group-item-action">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <img src="{{asset('public/assets/img/brand/logo.png')}}" class="avatar rounded-circle">
                                        <span class="mb-0 text-sm  font-weight-bold">DiphRate</span>
                                    </div>
                                    <div class="col ml--2">
            ...
            <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                <li class="nav-item dropdown">
                  ...
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" src="{{asset('public/assets/img/brand/logo.png')}}">
                  </span>
